...
function TypographyBlockquoteComponent() {
  return (
...
function TypographyH1Component() {
  return (
...
function TypographyH2Component() {
  return (
...
function TypographyH3Component() {
  return (
...
function TypographyH4Component() {
  return (
...
function TypographyInlineCodeComponent() {
  return (
...
function TypographyListComponent() {
  return (
    <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
      <li>1st level of puns: 5 gold coins</li>
      <li>2nd level of jokes: 10 gold coins</li>
...
export const Blockquote: Story = {
  render: () => <TypographyBlockquoteComponent />,
};

export const Demo: Story = {
  render: () => <TypographyDemoComponent />,
};

export const H1: Story = {
  render: () => <TypographyH1Component />,
};

export const H2: Story = {
  render: () => <TypographyH2Component />,
};

export const H3: Story = {
  render: () => <TypographyH3Component />,
};

export const H4: Story = {
  render: () => <TypographyH4Component />,
};

export const InlineCode: Story = {
  render: () => <TypographyInlineCodeComponent />,
};

export const Large: Story = {
  render: () => <TypographyLargeComponent />,
};

export const Lead: Story = {
  render: () => <TypographyLeadComponent />,
};

export const List: Story = {
  render: () => <TypographyListComponent />,
};

export const Muted: Story = {
  render: () => <TypographyMutedComponent />,
};

export const P: Story = {
  render: () => <TypographyPComponent />,
};

export const Small: Story = {
  render: () => <TypographySmallComponent />,
};

export const Table: Story = {
  render: () => <TypographyTableComponent />,
};
