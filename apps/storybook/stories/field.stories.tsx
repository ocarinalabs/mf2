...
function FieldChoiceCardComponent() {
  return (
    <FieldGroup className="w-full max-w-xs">
      <FieldSet>
...
function FieldFieldsetComponent() {
  return (
...
function FieldResponsiveComponent() {
  return (
...
export const ChoiceCard: Story = {
  render: () => <FieldChoiceCardComponent />,
};

export const Demo: Story = {
  render: () => <FieldDemoComponent />,
};

export const Fieldset: Story = {
  render: () => <FieldFieldsetComponent />,
};
...
export const FieldInput: Story = {
  render: () => <FieldInputComponent />,
};

export const Radio: Story = {
  render: () => <FieldRadioComponent />,
};

export const Responsive: Story = {
  render: () => <FieldResponsiveComponent />,
};

export const FieldSelect: Story = {
  render: () => <FieldSelectComponent />,
};

export const FieldSlider: Story = {
  render: () => <FieldSliderComponent />,
};

export const FieldSwitch: Story = {
  render: () => <FieldSwitchComponent />,
};

export const FieldTextarea: Story = {
  render: () => <FieldTextareaComponent />,
};
